...
describe('eclog', () => {
    ...
    test('dcg with grammatical agreement', () => {
        // https://www-users.cs.umn.edu/~gini/prolog/dcg.html
        const is = (a, b) => (a === b ? a : _1.fail());
        const singular = Symbol(), plural = Symbol();
        const number = _1.default(singular, plural);
        const sentence = _1.default((n = number()) => [
            ...noun_phrase(n),
            ...verb_phrase(n)
        ]);
        const noun_phrase = _1.default((n) => [...determiner(n), ...noun(n)]);
        const noun = _1.default((n) => _1.when(n, {
            [singular]: _1.default(['cat'], ['man'], ['mouse']),
            [plural]: _1.default(['cats'], ['men'], ['mice'])
        }));
        const determiner = _1.default(n => (is(n, singular), ['a']), ['the'], n => (is(n, plural), []));
        const verb_phrase = _1.default((n) => [...verb(n), ...noun_phrase(number())]);
        const verb = _1.default((n) => _1.when(n, {
            [singular]: _1.default(['scares'], ['hates']),
            [plural]: _1.default(['scare'], ['hate'])
        }));
...
//# sourceMappingURL=eclog.test.js.map